...
**대상**: 컴퓨터공학부 3학년
**참여 기업**: 피앰아이(PMI), 디지털이엔에스(Digital ENS)
**진행 기간**: 2025학년도 2학기 (14주간)

### 🎯 프로젝트 주제
**자연어 질의 기반 패널 추출 아키텍처 구성**

현재 RDBMS에 저장된 패널 정보는 고객의 자연어 질의에 대해 매칭과 검색 효율성이 낮은 문제가 있습니다. 본 프로젝트는 이를 해결하기 위해:

- 🔤 **벡터화 및 모델링**: 패널 특성 정보 기반 Encoder-Decoder 아키텍처 설계
- 🔍 **추출 시스템**: 자연어 쿼리 입력 → 조건 맞는 패널 자동 추출 및 추천
- 💻 **프로토타입 구현**: 실제 동작하는 시스템 개발
